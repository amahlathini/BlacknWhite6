...
--
-- Host: localhost:3306
-- Generation Time: May 29, 2022 at 03:45 PM
...
(340, 'password_complexity_system', '0'),
(341, 'remember_device', '0'),
(342, 'auto_username', '0'),
...
CREATE TABLE `events` (
  ...
  `online_url` text CHARACTER SET utf8,
  `real_address` text CHARACTER SET utf8,
...
(1169, '', '', 'playlist_not_found', 'Playlist not found', 'قائمة التشغيل لم يتم العثور عليها', 'Afspeellijst niet gevonden', 'Liste de lecture introuvable', 'Wiedergabeliste nicht gefunden', 'Плейлист не найден', 'Lista de reproducción no encontrada', 'Çalma listesi bulunamadı'),
(1170, '', '', 'total_songs_sales', 'Total Songs Sold', 'إجمالي الأغاني المباعة', 'Totaal verkochte nummers', 'Total des chansons vendues', 'Gesamtlieder verkauft', 'Общее количество песен продано', 'Total de las canciones vendidas', 'Toplam şarkılar satıldı'),
(1171, '', '', 'total_tickets_sales', 'Total Tickets Sales', 'إجمالي مبيعات التذاكر', 'Totale tickets verkopen', 'Ventes totales de billets', 'Gesamtkartenverkäufe', 'Общая продажа билетов', 'Venta de boletos totales', 'Toplam bilet satışları'),
(1172, '', '', 'total_products_sales', 'Total Products Sold', 'إجمالي المنتجات المباعة', 'Totaal verkochte producten', 'Produits totaux vendus', 'Gesamtprodukte verkauft', 'Общая продукция продана', 'Productos totales vendidos', 'Satılan toplam ürünler'),
(1173, '', '', 'faqs', 'Faqs', 'الأسئلة الشائعة', 'FAQ\'s', 'FAQ', 'FAQs', 'Часто задаваемые вопросы', 'Preguntas frecuentes', 'SSS'),
(1174, '', '', 'yoomoney', 'Yoomoney', 'yoomoney', 'Yoomoney', 'Joom', 'Yoomoney', 'Yoomoney', 'Yoomoney', 'Yoomoney'),
(1175, '', '', 'empty_amount', 'Amount can not be empty', 'لا يمكن أن يكون المبلغ فارغًا', 'Bedrag kan niet leeg zijn', 'Le montant ne peut pas être vide', 'Menge kann nicht leer sein', 'Сумма не может быть пустой', 'La cantidad no puede estar vacía', 'Miktar boş olamaz'),
(1176, '', '', 'fortumo', 'Fortumo', 'فورتومو', 'Fortumo', 'Fortumo', 'Fortumo', 'Формумо', 'Fortumo', 'Fortumo'),
(1177, '', '', 'aamarpay', 'Aamarpay', 'Aamarpay', 'Aamarpay', 'Aamarpay', 'Aamarpay', 'Аамарпай', 'Aamarpay', 'Aamarpay'),
(1178, '', '', 'ngenius', 'Ngenius', 'Ngenius', 'NGENIUS', 'NGENIUS', 'Ngenius', 'Нгений', 'Nenio', 'Ngenius'),
(1179, '', '', 'coinbase', 'Coinbase', 'Coinbase', 'Coinbase', 'Coincement', 'Coinbase', 'Coinbase', 'Coinbase', 'Paraya bakan'),
(1180, '', '', 'coinpayments', 'Coinpayments', 'المدفوعات Coinpays', 'Munten', 'Paiement', 'Münzen', 'Coinpayments', 'Municipios', 'Madeni para'),
(1181, '', '', 'coinpayments_approved', 'Your payment using CoinPayments has been approved', 'تمت الموافقة على الدفع الخاص بك باستخدام المدفوعات coinpays', 'Uw betaling met behulp van CoinPayments is goedgekeurd', 'Votre paiement à l\'aide de CoinPayments a été approuvé', 'Ihre Zahlung mit Coinpayments wurde genehmigt', 'Ваш платеж с использованием CoinPayments был утвержден', 'Su pago utilizando CoinPayments ha sido aprobado', 'Coinpayments kullanarak ödemeniz onaylandı'),
(1182, '', '', 'coinpayments_canceled', 'Your payment using CoinPayments has been canceled', 'تم إلغاء الدفع الخاص بك باستخدام المدفوعات coinpays', 'Uw betaling met behulp van CoinPayments is geannuleerd', 'Votre paiement à l\'aide de CoinPayments a été annulé', 'Ihre Zahlung mit Coinpayments wurde storniert', 'Ваш платеж с использованием CoinPayments был отменен', 'Su pago utilizando CoinPayments ha sido cancelado', 'Coinpayments kullanarak ödemeniz iptal edildi'),
(1183, '', '', 'remember_device', 'Remember this device', 'تذكر هذا الجهاز', 'Onthoud dit apparaat', 'N\'oubliez pas cet appareil', 'erinnern Sie sich an dieses Gerät', 'Помните это устройство', 'Recuerde este dispositivo', 'Bu cihazı hatırla'),
(1184, '', '', 'least_characters', 'Must be at least 6 characters long.', 'يجب ألا يقل طول الأحرف عن 6 أحرف.', 'Moet minimaal 6 tekens lang zijn.', 'Doit contenir au moins 6 caractères.', 'Muss mindestens 6 Zeichen lang sein.', 'Должно быть не менее 6 символов длиной.', 'Debe tener al menos 6 caracteres de largo.', 'En az 6 karakter uzunluğunda olmalıdır.'),
(1185, '', '', 'contain_lowercase', 'Must contain a lowercase letter.', 'يجب أن تحتوي على حرف صغير.', 'Moet een kleine letter bevatten.', 'Doit contenir une lettre minuscule.', 'Muss einen Kleinbuchstaben enthalten.', 'Должен содержать строчную букву.', 'Debe contener una letra minúscula.', 'Küçük bir harf içermelidir.'),
(1186, '', '', 'contain_uppercase', 'Must contain an uppercase letter.', 'يجب أن تحتوي على حرف كبير.', 'Moet een hoofdletter bevatten.', 'Doit contenir une lettre majuscule.', 'Muss einen Großbuchstaben enthalten.', 'Должен содержать заглавную букву.', 'Debe contener una letra mayúscula.', 'Bir büyük harf içermeli.'),
(1187, '', '', 'number_special', 'Must contain a number or special character.', 'يجب أن تحتوي على رقم أو شخصية خاصة.', 'Moet een nummer of speciaal teken bevatten.', 'Doit contenir un numéro ou un caractère spécial.', 'Muss eine Nummer oder ein spezielles Zeichen enthalten.', 'Должен содержать номер или особый характер.', 'Debe contener un número o carácter especial.', 'Bir sayı veya özel karakter içermelidir.'),
(1188, '', '', 'complexity_requirements', 'The password supplied does not meet the minimum complexity requirements', 'لا تلبي كلمة المرور المقدمة الحد الأدنى من متطلبات التعقيد', 'Het geleverde wachtwoord voldoet niet aan de minimale complexiteitsvereisten', 'Le mot de passe fourni ne répond pas aux exigences de complexité minimale', 'Das gelieferte Passwort entspricht nicht den Anforderungen an die Mindestkomplexität', 'Поставляемый пароль не соответствует требованиям к минимальной сложности', 'La contraseña suministrada no cumple con los requisitos mínimos de complejidad', 'Sağlanan şifre, asgari karmaşıklık gereksinimlerini karşılamıyor'),
(1189, '', '', 'first_name', 'First Name', 'الاسم الاول', 'Voornaam', 'Prénom', 'Vorname', 'Имя', 'Primer nombre', 'İlk adı'),
(1190, '', '', 'last_name', 'Last Name', 'الكنية', 'Achternaam', 'Nom de famille', 'Nachname', 'Фамилия', 'Apellido', 'Soy isim'),
(1191, '', '', 'first_name_last_name_empty', 'Your First Name and Last Name can not be empty.', 'اسمك الأول واسم العائلة لا يمكن أن يكون فارغًا.', 'Uw voornaam en achternaam kunnen niet leeg zijn.', 'Votre prénom et votre nom de famille ne peuvent pas être vides.', 'Ihr Vorname und Ihr Nachname können nicht leer sein.', 'Ваше имя и фамилия не могут быть пустыми.', 'Su primer nombre y apellido no pueden estar vacíos.', 'Adınız ve soyadınız boş olamaz.'),
(1192, '', '', 'terms_of_use_page', '&lt;h4&gt;1- Write your Terms Of Use here.&lt;/h4&gt; <br>&lt;p&gt; &lt;/p&gt; <br>&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adisdpisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis sdnostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt; <br>&lt;p&gt; &lt;/p&gt; <br>&lt;h4&gt;2- Random title&lt;/h4&gt; <br>&lt;p&gt; &lt;/p&gt; <br>&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;', '<h4> 1- اكتب شروط الاستخدام هنا. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet ، exectetur adisdpising elit ، sed do eiusmod incididunt ut labore et ', '<H4> 1- Schrijf hier uw gebruiksvoorwaarden. </h4> <br> <p> </p> <br> <p> Lorem ipsum dolor sit amet, consectetur adisdpisicing elit, sed do eiusmod Temporidunt ut labore et ', '<h4> 1- Écrivez vos conditions d\'utilisation ici. </h4> <br> <p> </p> <br> <p> Lorem ipsum Dolor Sit Amet, Consectetur AdisdPising elit, sed do eiusmod tempory incidint ut Labore et ', '<h4> 1- Schreiben Sie hier Ihre Nutzungsbedingungen. ', '<h4> 1- Напишите свои условия использования здесь. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet, edisdpising elit, sed do eiusmod temper indicidunt ut labore et ', '<H4> 1- Escriba sus términos de uso aquí. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet, consectetur adisdpising elit, sed do do temporal incididunt ut labore et labore et do ', '<h4> 1- Kullanım Koşullarınızı buraya yazın. '),
(1193, '', '', 'about_page', '&lt;h4&gt;1- Write your About us here.&lt;/h4&gt; <br>&lt;p&gt; &lt;/p&gt; <br>&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adisdpisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis sdnostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt; <br>&lt;p&gt;&lt;br /&gt; &lt;br /&gt; &lt;/p&gt; <br>&lt;h4&gt;2- Random title&lt;/h4&gt; <br>&lt;p&gt; &lt;/p&gt; <br>&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;', '] ', '<H4> 1- Schrijf hier over ons. </h4> <br> <p> </p> <br> <p> Lorem ipsum dolor sit amet, consectetur adisdpisicing elit, sed do eiusmod temporididunt ut labore et dolore ', '<h4> 1- Écrivez-vous sur nous ici. </h4> <br> <p> </p> <br> <p> Lorem ipsum Dolor Sit Amet, Consectetur AdisdPising elit, sed do eiusmod tempory incidid ut Labore et Dolore ', '<h4> 1- Schreiben Sie hier über uns. ', '<h4> 1- Напишите свое о нас здесь. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet, adisdpising elit, sed do eiusmod temper indicunt ut labore et dolore ', '<h4> 1- Escribe tu sobre nosotros aquí. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet, consectetur adisdpising elit, sed do do temporal incididunt ut labore et dolorore ', '<h4> 1- Bizim hakkımızda buraya yazın. '),
(1194, '', '', 'privacy_policy_page', '&lt;h4&gt;1- Write your Privacy Policy here.&lt;/h4&gt; <br>&lt;p&gt; &lt;/p&gt; <br>&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adisdpisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis sdnostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt; <br>&lt;p&gt;&lt;br /&gt; &lt;br /&gt; &lt;/p&gt; <br>&lt;h4&gt;2- Random title&lt;/h4&gt; <br>&lt;p&gt; &lt;/p&gt; <br>&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;', '<h4> 1- اكتب سياسة الخصوصية الخاصة بك هنا. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet ، exectetur adisdpising elit ، sed do eiusmod incididunt ut labore et dolore ', '<H4> 1- Schrijf hier uw privacybeleid. </h4> <br> <p> </p> <br> <p> Lorem ipsum dolor sit amet, Consectetur adisdpisicing elit, sed do eiusmod Temporidunt ut labore et dolore et dolore ', '<h4> 1- Écrivez votre politique de confidentialité ici. </h4> <br> <p> </p> <br> <p> Lorem ipsum Dolor Sit Amet, Consectetur AdisdPising elit, sed do eiusmod tempory incidint ut Labore et Dolore ', '<h4> 1- Schreiben Sie hier Ihre Datenschutzrichtlinie. ', '<h4> 1- Напишите свою политику конфиденциальности здесь. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet, edisdpising elit, sed do eiusmod temper indicunt ut labore et dolore ', '<h4> 1- Escriba su política de privacidad aquí. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet, consectetur adisdpising elit, sed do do temporal incididunt ut labore et dolorore ', '<h4> 1- Gizlilik politikanızı buraya yazın. '),
(1195, '', '', 'dmca_terms_page', '&lt;h4&gt;1- Write your DMCA Notice.&lt;/h4&gt; <br>&lt;p&gt; &lt;/p&gt; <br>&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adisdpisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis sdnostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt; <br>&lt;p&gt;&lt;br /&gt; &lt;br /&gt; &lt;/p&gt; <br>&lt;h4&gt;2- Random title&lt;/h4&gt; <br>&lt;p&gt; &lt;/p&gt; <br>&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;', '<h4> 1- اكتب إشعار DMCA الخاص بك. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet ، exectetur adisdpising elit ، sed do eiusmod regiDunt ut labore et dolore magna ', '<H4> 1- Schrijf uw DMCA-kennisgeving. </h4> <br> <p> </p> <br> <p> Lorem ipsum dolor sit amet, Consectetur adisdpisicing elit, sed do eiusmod temporidInt ut labore et dolore magna ', '<h4> 1- Écrivez votre avis DMCA. </h4> <br> <p> </p> <br> <p> Lorem ipsum Dolor Sit Amet, Consectetur AdisdPising elit, sed do eiusmod tempory incidint ut Labore et Dolore Magna ', '<h4> 1- Schreiben Sie Ihren DMCA-Hinweis. ', '<h4> 1- Напишите свое уведомление DMCA. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet, edisdpising elit, sed do eiusmod temper indicunt ut labore et dolore magna ', '<H4> 1- Escriba su aviso de DMCA. </h4> <br> <p> </p> <br> <p> lorem ipsum dolor sit amet, consectetur adisdpising elit, sed do do temporal incididunt ut labore et dolor Magna ', '<h4> 1- DMCA bildiriminizi yazın. ');
...
CREATE TABLE `orders` (
  ...
  `final_price` float NOT NULL DEFAULT '0',
  `units` int(11) NOT NULL DEFAULT '0',
  `tracking_url` text CHARACTER SET utf8,
...
CREATE TABLE `users` (
  ...
  `info_file` text CHARACTER SET utf8,
  ...
  `fortumo_hash` text CHARACTER SET utf8,
...
ALTER TABLE `users`
  ...
  ADD KEY `cashfree_key` (`cashfree_key`),
